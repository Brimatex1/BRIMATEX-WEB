...
const TWILIO_WHATSAPP_FROM = process.env.TWILIO_WHATSAPP_FROM || 'whatsapp:+14155552671'; // Twilio sandbox default
...
async function sendInvoiceViaWhatsApp(customerPhone, invoiceName, invoiceStatus, total, orderName) {
  ...
  // Format phone: add country code if missing (assume Saudi Arabia +966)
